          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 list-disc list-inside text-muted-foreground">
                ...
                <li>Competitive 5% commission - only pay when your plate sells</li>
            ...
            <div className="space-y-4">
              ...
              <ol className="space-y-2 list-decimal list-inside text-muted-foreground">
                ...
                <li>You receive your payment minus our 5% fee</li>
              </ol>
            </div>
          </motion.div>
          ...
          >
            {isSubmitted ? (
              ...
              <div className="border rounded-lg p-6 space-y-6">
                <h3 className="text-xl font-bold">Sell Your Plate - 5% Commission Fee</h3>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      ...
                      Our commission fee is 5% of the final selling price.
                    </p>
                  </form>
                </Form>
              </div>
