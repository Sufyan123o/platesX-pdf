...
const guides = [
  {
    ...
    description: "Understanding the value and investment potential of dateless registration plates",
  ...
  return (
    <section id="guides" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl">Registration Guides</h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Expert resources to help you navigate the private plates investment market
          </p>
        </motion.div>
